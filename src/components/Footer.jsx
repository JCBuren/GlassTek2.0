...
const Footer = () => {
	return (
		<footer className="bg-dark-purple text-white">
			<div className=" md:flex md:justify-between md:items-center sm:px-12 px-4  bg-[#ffffff19] py-12 ">
				...
				<div className="grid grid-cols-1">
					<h1 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold underline">
						Hours:
					</h1>
					...
					<a>
						Location:{" "}
						<span>4020 W. Tickman St. #129 Sioux Falls, SD 57107</span>
					</a>
					<a>
						Phone: <span>605-951-9314</span>
					</a>
				</div>
